...
Template: https://github.com/jetlauncher/limitless-ad-engine
สร้างสำเนา: https://github.com/new?template_name=limitless-ad-engine&template_owner=jetlauncher

เริ่มใช้งาน: เปิด repo ของคุณใน Codex / Claude Code หรือ clone ลงเครื่อง ใช้ Python 3.11 ขึ้นไป แล้วรัน python3 student.py preview เปิด http://localhost:8767 จะเห็นตัวอย่าง 3 แอด ไม่ต้องมี API key หยุดด้วย Ctrl+C แล้วรันใหม่หลังแก้ไฟล์

แก้ข้อมูลธุรกิจใน student/brand.json: ชื่อ ลูกค้า ข้อเสนอ CTA ลิงก์ และหลักฐาน
แก้หน้าเว็บใน student/site.json: ชื่อเว็บ ข้อความหน้าแรก และสี
แก้แอดใน student/ads.json: หัวข้อ มุมขาย caption และ images
ใส่ภาพ PNG ของคุณใน student/assets/ ขนาด 1080×1080, 1080×1350 หรือ 1080×1920
เลือกคู่แข่งและแบรนด์ต้นแบบใน student/watchlist.json
ใส่ผล normalize ใน student/references.json
ปรับหน้าเว็บและปุ่มได้ทั้งหมดใน web/index.html, web/styles.css และ web/app.js

ชื่อบนเว็บกับชื่อธุรกิจอยู่คนละไฟล์ ให้แก้ site.json และ brand.json ให้ตรงกัน การเปลี่ยนข้อความหรือสีเว็บไม่เปลี่ยนตัวหนังสือในรูปเดิม ต้องเปลี่ยนภาพจาก Canva หรือ render ภาพใหม่ คำสั่งและตัวอย่างพร้อมใช้ทั้งหมดอยู่ใน README ของ repo

Prompt ให้นักเรียนคัดลอกใช้กับ AI:
...
เมื่อพร้อมสร้างแอดจริง: เปลี่ยนข้อเสนอ ภาพ แคปชั่น ปลายทาง และหลักฐานสิทธิ์ให้ครบก่อนเปลี่ยน demo เป็น false ใช้ student.py pack สร้าง draft ให้คนตรวจ แล้วใช้ scripts/approve_pack.py และ engine.py export สร้าง ZIP การ preview จาก student/ จะเป็น draft เสมอ หน้าแจกแพ็กที่ตรวจแล้วใช้ advanced build ตาม OPERATOR-GUIDE.md

Vercel ตั้งค่าให้ build จาก student/ ไป dist/ โดยอัตโนมัติ นักเรียน import repo ของตัวเองแล้วตรวจ Preview ก่อนเผยแพร่ คลังเดิม 675 รายการอยู่ใน legacy/ เพื่อศึกษา ไม่รวมในหน้าเริ่มต้น เว็บเป็น static ไม่มี login ข้อมูลบนเว็บที่เผยแพร่จึงต้องเป็นข้อมูลที่ตั้งใจให้ผู้เข้าชมเห็น

ลำดับเรียนที่แนะนำ: คาบ 1 สร้างสำเนาและเปลี่ยนแบรนด์ → คาบ 2 เลือก reference และเขียน 3 มุมขาย → คาบ 3 ผลิตภาพและตรวจแพ็ก → คาบ 4 เผยแพร่ gallery ของตัวเองและบันทึกผลการทดสอบจริง เกณฑ์ผ่านคือมี repo ของตัวเอง แอดใหม่ 3 ชิ้น พร้อมภาพ caption CTA และปลายทางที่ตรวจแล้ว ไม่ใช่แค่เปิดเว็บตัวอย่างได้
...
ระบบเวอร์ชันนี้เป็น local-first MVP นักเรียนสร้างสำเนา repo ของตัวเองเพื่อปรับแบรนด์และสร้างแพ็กได้ ผู้ดูแลใช้ advanced workflow จัดคลังที่ตรวจแล้วส่งให้เปิดบนมือถือได้ ยังไม่มีระบบบัญชีนักเรียนหรือพื้นที่ส่วนตัวบนเว็บ แต่ repo ของแต่ละคนแยกจากกัน
...
student/watchlist.json เริ่มจากช่องคู่แข่งและแบรนด์ต้นแบบแบบกลางที่นักเรียนกรอกเอง ยังปิดการทำงานและเว้น page ID ไว้ ส่วน config/watchlist.example.json เป็นตัวอย่างสำหรับผู้ดูแล ห้ามใช้ชื่อเพจคล้ายกันแทนโดยไม่ตรวจ
